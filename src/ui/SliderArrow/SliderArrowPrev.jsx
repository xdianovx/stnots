...
export const SliderArrowPrev = ({ refEl, className, props }) => {
  return (
    <div
      ref={refEl}
      {...props}
    ...
    >
      <Arrow className="stroke-black rotate-180 dark:stroke-white transition-colors group-hover:stroke-white dark:group-hover:stroke-black" />
    </div>
  );
};
